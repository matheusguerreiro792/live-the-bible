  ...
  >
    ...
    >
      ...
      <div class="flex flex-col gap-4">
        ...
        <h2 class="font-semibold text-3xl text-fuchsia-950 mt-2">{{ studie.title }}</h2>
...
<style scoped>
.markdown-content :deep(h2) { color: var(--color-fuchsia-950); font-weight: 600; font-size: 1.25rem; }
.markdown-content :deep(h3) { color: var(--color-fuchsia-950); font-weight: 600; font-size: 1.125rem; }
.markdown-content :deep(p) { color: var(--color-neutral-950); }
.markdown-content :deep(strong) { color: var(--color-fuchsia-900); font-weight: 700; }
.markdown-content :deep(ul) { list-style-type: disc; margin-left: 1.125rem; display: flex; flex-direction: column; gap: 0.5rem; }
.markdown-content :deep(ol) { list-style-type: decimal; margin-left: 1.125rem; display: flex; flex-direction: column; gap: 0.5rem; }
.markdown-content :deep(hr) { border-top: 1px solid var(--color-fuchsia-900); margin-top: 0.25rem; }
